...
<div class="bg-gray-50 min-h-screen">
    <div class="max-w-3xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-gray-600">Isi form berikut untuk menambahkan data pelanggan baru.</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="name" id="name" required 
                               ...
                               value="{{ old('name') }}" placeholder="Contoh: Bpk. Ahmad">
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" 
                               class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-colors"
                               value="{{ old('email') }}" placeholder="Contoh: ahmad@gmail.com">
                        @error('email')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
