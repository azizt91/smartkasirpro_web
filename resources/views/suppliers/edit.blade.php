...
<div class="bg-gray-50 min-h-screen">
    <div class="max-w-3xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        <div class="mb-8">
            ...
            <p class="mt-2 text-sm text-gray-600">Perbarui informasi data supplier Anda.</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="text" name="name" id="name" required 
                               ...
                               value="{{ old('name', $supplier->name) }}" placeholder="Contoh: PT. Sumber Makmur">
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="text" name="contact_person" id="contact_person" 
                               class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-colors"
                               value="{{ old('contact_person', $supplier->contact_person) }}" placeholder="Contoh: Bpk. Budi">
                    ...
                    <div>
                        ...
                        <input type="text" name="phone" id="phone" 
                               class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-colors"
                               value="{{ old('phone', $supplier->phone) }}" placeholder="Contoh: 08123456789">
                        @error('phone')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="col-span-2">
                        ...
                        <input type="email" name="email" id="email" 
                               class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-colors"
                               value="{{ old('email', $supplier->email) }}" placeholder="Contoh: info@sumbermakmur.com">
                        @error('email')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
