<x-guest-layout>
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
        ...
        <div class="text-center mb-8">
            <div class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-green-500 to-blue-600 rounded-xl mb-4">
        ...
        <form method="POST" action="{{ route('register') }}" class="space-y-6">
            ...
            <div class="flex items-start space-x-3 p-4 bg-gray-50 rounded-xl">
                ...
                <label for="terms" class="text-sm text-gray-600">
                    ...
                    <a href="#" class="text-green-600 hover:text-green-800 font-medium">Syarat & Ketentuan</a> 
                    dan 
            ...
            <!-- Register Button -->
            <button type="submit" 
                    class="w-full bg-gradient-to-r from-green-500 to-blue-600 text-white font-semibold py-3 px-4 rounded-xl hover:from-green-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transform hover:scale-[1.02] transition-all duration-200 shadow-lg">
